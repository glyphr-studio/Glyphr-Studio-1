...
function loadPage_globalactions() {
	...
	var con =
		'<h1 class="pagetitle">Global Actions</h1><div class="pagecontent textpage">';

	con +=
		'This page contains actions that affect many glyphs at once.  Actions taken here ' +
	...
	con +=
		'<div class="effect">Individual Glyphs, Ligatures, and Components will be moved.  To avoid double-moving ' +
	...
	con +=
		'<div class="effect">Individual Glyphs, Ligatures, and Components will be re-sized.  To avoid double-re-sizing ' +
	...
	con +=
		'<div class="effect">Every shape in every Glyph, Component, and Ligature will have the \'Turn Component Instance ' +
	...
	con +=
		'<div class="effect">Each ligature and glyph\'s Auto Width property will be set to false, and it\'s ' +
	...
	con +=
		'<div class="effect">Capital letters will be added as Component Instances to their lowercase counterparts.</div>';
	con += '<table class="settingstable">';
	con +=
	...
	con +=
		'<br><b>Please Note</b> - The diacritical glyphs that are in the Basic Latin range are usually designed to be stand-alone. ' +
	...
	con +=
		'<div class="effect">The Latin Supplement character range will be enabled, and diacritical glyphs will be assembled ' +
	...
	con +=
		'<br><b>Before you begin</b> - <span class="textaction" onclick="showGlyphRangeChooser();">Add the Combining Diacritical Marks range ' +
		'to your project</span>, and design them.';
	con +=
		'<div class="effect">The Latin Supplement and Latin Extended A character ranges will be enabled, and diacritical glyphs will be assembled ' +
...
function updateAllGlyphSizesByEm() {
	...
	var updatewidthprop = document.getElementById(
		'updateglyphwidthproperty'
	).checked;
...
function generateDiacriticsAdvanced() {
	...
	function doOneGlyph() {
		...
		if (sourceArray) {
			...
			getGlyph(currglyphid).shapes[1].updateShapePosition(
				targetCenter - currCenter,
				0
			);
		}
