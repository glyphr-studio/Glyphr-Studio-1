...
function makeUsedInThumbs() {
	...
	var unique = ui.filter(function (elem, pos) {
...
function componentInstanceDetails(s) {
	...
	content +=
		...
		'<td>' +
		checkUI('_UI.ms.shapes.getSingleton().flipew', s.flipew, true) +
		'</td>' +
		'</tr>';
	...
	content +=
		...
		'<td> flip vertical </td>' +
		'<td>' +
		checkUI('_UI.ms.shapes.getSingleton().flipns', s.flipns, true) +
		'</td>' +
		'</tr>';
	...
	content +=
		...
		'<td>' +
		checkUI(
			'_UI.ms.shapes.getSingleton().reversewinding',
			s.reversewinding,
			true
		) +
		'</td>' +
	...
	content +=
		...
		'<td> rotate first </td>' +
		'<td>' +
		checkUI('_UI.ms.shapes.getSingleton().rotatefirst', s.rotatefirst, true) +
		'&ensp;' +
		helpUI(rotationhelp) +
		'</td>' +
		'</tr>';
