...
function makeGlyphrStudioLogo(oa) {
  ...
  var re =
    '<svg version="1.1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" x="0px" y="0px" width="' +
    width +
    'px" height="' +
    height +
    'px" viewBox="0 0 ' +
...
function makeActionButton_DeleteGlyph() {
  ...
  re +=
    '<path fill="' +
    fill +
    '" d="M20.2,18.5H10L7.8,25h3.5v3.6H0V25h3.5l7.8-21.8H7.8V0h14.6v3.2h-3.6l8,21.8H30v3.6H18.8V25h3.5L20.2,18.5zM19.2,15.2L15.4,3.2H15l-4,11.9H19.2z"/>';
...
function makeActionButton_Round() {
  ...
  re +=
    '<path fill="' +
    red +
    '" d="M17.4,21.9c0.4,0.5,2-0.5,1.4-1.4c-1.3-1.9-4.8-5.9-6.5-7.3C11.1,12.2,10,13,10,13S14.4,17.5,17.4,21.9z"/>';
  re +=
    '<path fill="' +
    red +
    '" d="M12.2,21.6c-0.5,1-2.1-0.1-1.3-1.2c1.5-2.2,4.4-6.4,6.5-7.9c1.3-1,2.1-0.1,2.1-0.1S14.9,16.7,12.2,21.6z"/>';
  re +=
    '<path fill="' +
    red +
    '" d="M28,21.9c0.4,0.5,2-0.5,1.4-1.4c-1.3-1.9-4.8-5.9-6.5-7.3c-1.2-1-2.3-0.3-2.3-0.3S24.9,17.5,28,21.9z"/>';
  re +=
    '<path fill="' +
    red +
    '" d="M22.7,21.6c-0.5,1-2.1-0.1-1.3-1.2c1.5-2.2,4.4-6.4,6.5-7.9c1.3-1,2.1-0.1,2.1-0.1S25.5,16.7,22.7,21.6z"/>';
...
function makePointButton(type, selected) {
  ...
  re +=
    ...
    ';" ';
  re +=
    "onclick=\"_UI.ms.points.setPointType('" +
    type +
    "'); history_put('Point Type: " +
    type +
...
function lockUI(varname, currbool, idname) {
  ...
  var re =
    "<svg " +
    'version="1.1" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink" xml:space="preserve" ' +
