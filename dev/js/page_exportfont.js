 // start of file
	...
	function loadPage_exportfont(){
		...
		content += '<br><table><tr><td style="padding-top:10px;">'+makeIcon({'name':'nav_exportsvg', 'size':60, 'color':_UI.colors.accent_55, 'hovercolor':false})+'</td><td style="padding-left:20px;">'+
		...
		content += '<table><tr><td style="padding-top:10px;">'+makeIcon({'name':'nav_exportotf', 'size':60, 'color':_UI.colors.gray_80, 'hovercolor':false})+'</td><td style="padding-left:20px;">'+
