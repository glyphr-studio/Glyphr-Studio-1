...
var _UI = {
	...
	thisGlyphrStudioVersionNum: '1.13.15',
	thisGlyphrStudioVersionDate: 1672870000000,
	...
	testactions: [
		{
			name: 'Flatten',
			onclick:
				"getSelectedWorkItem().flattenGlyph(); history_put('flatten'); redraw();",
		},
		{
			name: 'Combine',
			onclick:
				"getSelectedWorkItem().combineAllShapes(true, true); history_put('combine'); redraw();",
		},
		{
			name: 'Resolve',
			onclick:
				"getSelectedWorkItem().resolveOverlapsForAllShapes(); history_put('resolve overlaps');",
		},
		{
			name: 'CombRes',
			onclick:
				"getSelectedWorkItem().combineAllShapes(true); history_put('combine and resolve'); redraw();",
		},
		{
			name: 'Draw IX',
			onclick:
				'getSelectedWorkItemShapes()[0].path.getPolySegment().drawIntersections();',
		},
	],
	testOnLoad: function () {},
	...
	metadatahelp: {
		font_family: '',
		font_style:
			'Thin, ExtraLight, Light, <b>Regular</b>, Medium, SemiBold, <b>Bold</b>, ExtraBold, Black, Thin&nbsp;Italic, ExtraLight&nbsp;Italic, Light&nbsp;Italic, <b>Italic</b>, Medium&nbsp;Italic, SemiBold&nbsp;Italic, Bold&nbsp;Italic, ExtraBold&nbsp;Italic, Black&nbsp;Italic ',
		font_variant: 'normal, small-caps',
		font_weight: 'normal, bold, or a number 100-900',
		font_stretch:
			'normal, ultra-condensed, extra-condensed, condensed, semi-condensed, semi-expanded, expanded, extra-expanded, ultra-expanded',
		panose_1:
			'Uses ten digits to describe the font\'s visual style.  A good overview can be found on Monotype\'s GitHub page: <a href="https://monotype.github.io/panose/pan2.htm" target="_blank">monotype.github.io/panose/pan2.htm</a>.',
		stemv: 'Average measurement of vertical stems.',
		stemh: 'Average measurement of horizontal stems.',
		slope:
			'If italic, this is the slant angle, measured counterclockwise from vertical. Or zero for non-italic fonts.',
		underline_position: '',
		underline_thickness: '',
